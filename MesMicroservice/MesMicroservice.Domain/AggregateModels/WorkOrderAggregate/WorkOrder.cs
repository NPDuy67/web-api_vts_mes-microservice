...
public class WorkOrder : Entity, IAggregateRoot
{
    ...
    public List<WorkOrderEquipmentRequirement> EquipmentRequirements { get; private set; }
    public List<EquipmentWorkOrder> AssignedEquipments { get; private set; } = new();

#pragma warning disable CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
    private WorkOrder() { }

    public WorkOrder(string workOrderId, DateTime dueDate, TimeSpan duration, DateTime? startTime, DateTime? endTime, EWorkOrderStatus workOrderStatus, List<WorkOrder> prerequisiteOperations, WorkCenter? workCenter, decimal productionTarget, List<WorkOrderEquipmentRequirement> equipmentRequirements)
    {
