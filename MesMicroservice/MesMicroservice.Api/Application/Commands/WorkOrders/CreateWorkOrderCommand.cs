...
public class CreateWorkOrderCommand : IRequest<bool>
{
    ...
    public CreateWorkOrderCommand(string manufacturingOrderId, string workOrderId, DateTime dueDate, DateTime startTime, DateTime endTime, EWorkOrderStatus workOrderStatus, List<string> prerequisiteOperations, string? workCenter)
    {
