...
public class UpdateResourceNetworkConnectionCommand : IRequest<bool>
{
    ...
    public UpdateResourceNetworkConnectionCommand(string resourceRelationshipNetworkId, string connectionId, string description, List<SavePropertyViewModel> properties, string fromResource, string toResource)
    {
