...
namespace MesMicroservice.Api.Migrations
{
    ...
    [Migration("20240111110430_AddManufacturingRecord")]
    partial class AddManufacturingRecord
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MesMicroservice.Domain.AggregateModels.ManufacucturingRecordAggregate.ManufacturingRecord", b =>
                {
                    ...
                    b.HasOne("MesMicroservice.Domain.AggregateModels.MaterialDefinitionAggregate.MaterialUnit", "OutputUnit")
                        .WithMany()
            ...
            modelBuilder.Entity("MesMicroservice.Domain.AggregateModels.EquipmentAggregate.Equipment", b =>
                {
                    ...
                    b.HasOne("MesMicroservice.Domain.AggregateModels.HierarchyModelAggregate.WorkUnit", "WorkUnit")
