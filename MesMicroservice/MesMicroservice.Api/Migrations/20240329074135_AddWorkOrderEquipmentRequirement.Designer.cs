...
namespace MesMicroservice.Api.Migrations
{
    ...
    [Migration("20240329074135_AddWorkOrderEquipmentRequirement")]
    partial class AddWorkOrderEquipmentRequirement
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WorkOrderEquipments", b =>
                {
                    b.Property<int>("AssignedEquipmentsId")
                        .HasColumnType("int");

                    b.Property<int>("WorkOrderId")
                        .HasColumnType("int");

                    b.HasKey("AssignedEquipmentsId", "WorkOrderId");
            ...
            modelBuilder.Entity("WorkOrderEquipments", b =>
                {
                    b.HasOne("MesMicroservice.Domain.AggregateModels.EquipmentAggregate.Equipment", null)
                        .WithMany()
                        .HasForeignKey("AssignedEquipmentsId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
